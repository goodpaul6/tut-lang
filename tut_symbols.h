...
// If a usertype by the name cannot be found, an undefined version of the type
...
// If a typetag by "name" does not exist then it is created
...
// If scope is -1, it is automatically set to the symbol table's curScope
